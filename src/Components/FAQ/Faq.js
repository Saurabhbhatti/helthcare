...
function dropdown() {
  return (
    <div className="dropdown">
      ...
      <DropdownCard
        question="What is Off the Charts' telehealth treatment?"
        answer="Off the Charts offers an affordable telehealth treatment for weight loss, providing FDA-approved medications like Semaglutide along with personalized treatment plans, routine consultations, and access to medical weight management programs."
      />
      <DropdownCard
      ...
      />
      <DropdownCard
        question="What are the benefits of Off the Charts' weight management programs?"
      ...
      <DropdownCard
        ...
        answer="Yes, Off the Charts' telehealth treatment is designed to be affordable and accessible, ensuring that individuals struggling with weight loss can receive effective care without financial barriers."
      />
    </div>
  );
}
