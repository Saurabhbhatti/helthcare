      ...
      <Slider {...sliderSettings}>
          ...
          <div className="card3">
            ...
            <div className="upper-content">
              <p className="paragraphslider">
                ...
                healthy, just not as much, and occasionally cheat, but the
        ...
        <div>
          <div className="card3">
            ...
            <div className="upper-content">
              <p className="paragraphslider">
                “My experience was very good. Dr Schube addressed all my
                questions and was very responsive when going through the
                process. Overall I would highly recommend his service.”
              </p>
            </div>
            <div className="lower-content">
              <p>Sherita C</p>
          ...
          <div className="card3">
            ...
            <div className="upper-content">
              <p className="paragraphslider">
                ...
                results and lose weight at what I feel is a sustainable rate.
                The doctors are responsive and available whenever I need them. I
                have and will continue to recommend friends to Fit Body Faster!”
              </p>
            </div>
            <div className="lower-content">
              <p>Abi C</p>
