    ...
    <div className="containerbook">
      ...
      <div className="text-container">
        <div className='img-text'>
          <img src={textimg1} alt="Image Description" width="50" height="50" style={{ paddingRight: '60px', paddingTop: '20px' }} />
          <div>
            <h2><span>Initial Consultation</span></h2>
            <p>"Kickstart your weight loss journey with <br /> OTC BODY in just three steps! Begin <br /> by scheduling a consultation to discuss <br /> your goals and medical history." </p>
          </div>
        </div>
        <div className='img-text'>
          <img src={textimg2} alt="Image Description" width="50" height="50" style={{ paddingRight: '30px', paddingTop: '20px' }} />
          <div>
        ...
        <div className='img-text'>
          <img src={textimg3} alt="Image Description" width="50" height="50" style={{ paddingRight: '30px', paddingTop: '20px' }} />
          <div>
