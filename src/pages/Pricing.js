      ...
      <div className='container'>
        ...
        <div className='plan-table' role='table'>
          <div className='table-row' role='row'>
            <div
              className='table-cell no-border align-right text-color'
              role='columnheader'
            >
              SKU#
            </div>
            ...
            <div
              className='table-cell attractive-cell rounded-cell cell-center'
              role='cell'
            >
              5 ML
            </div>
          ...
          <div className='table-row' role='row'>
            ...
            <div
              className='table-cell weeks-cell rounded-cell cell-center'
              role='cell'
            >
              12-15 WEEKS
            </div>
